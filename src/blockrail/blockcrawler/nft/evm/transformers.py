...
from blockrail.blockcrawler.evm.types import Erc165InterfaceID, Address
...
from blockrail.blockcrawler.nft.evm.oracles import LogVersionOracle, TokenTransactionTypeOracle
