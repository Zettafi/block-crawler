...
from blockrail.blockcrawler.core.data_clients import DataReader
from blockrail.blockcrawler.core.stats import StatsService
from blockrail.blockcrawler.core.storage_clients import S3StorageClient


class S3StorageClientTestCase(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self) -> None:
        self.__s3_bucket = AsyncMock()
        patcher = patch("blockrail.blockcrawler.core.storage_clients.aioboto3")
